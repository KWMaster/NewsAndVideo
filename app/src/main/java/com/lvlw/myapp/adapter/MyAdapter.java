...
import com.lvlw.myapp.fileutils.FileDirScaner;
import com.lvlw.myapp.ijkplayer.IjkFullscreenActivity;
...
public class MyAdapter extends BaseAdapter {
    ...
    static class ViewHolder {
        ...
        TextView tvFileMsg;
        @BindView(R.id.file_detial)
        LinearLayout fileDetial;
        @BindView(R.id.ibtn_file_operate)
        CheckBox ibtnFileOperate;
