...
import com.lvlw.myapp.adapter.ScanSetPagerAdapter;
import com.lvlw.myapp.eventmessage.AddClickTimes;
...
public class FileScanSetFragment extends SkinBaseFragment {
    @BindView(R.id.scan_tabs)
    PagerSlidingTabStrip scanTabs;
    @BindView(R.id.scan_pagers)
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        setTabValue();
        dynamicAddView(scanTabs,"PagerSlidingTabStripbgd",R.color.main_color);
        dynamicAddView(scanTabs,"PagerSlidingTabStripidc",R.color.launcher_item_select);
